#
# R code to reproduce plot2 as plot2.png
#
...
# is to reconstruct a line graph showing how Global Active power
# changes over the days between 2007-02-01 between 2007-02-2
#
...
# 'plot2.png' sized as 480x480  (the default but we specify to
# be certian)
png(filename='plot2.png', widt = 480, height=480)

# Now we create a line plot (type=l) with no x-axis labels (xact=n) as
# we will add these later. We label the y-axis with
# 'Global Active Power (kilowatts)' and a blank x-axis label
